...
const produto = {
    marca: 'Piraquê',
    tipo: 'bicoito maltado',
    nota: undefined
    }
function removerPropriedade( obj, propriedadeASerExcluida){
   // const copia = Object.assign({}, obj)
   // delete copia[propriedadeASerExcluida]
    const copia = {...obj}
    delete copia[propriedadeASerExcluida]

    return copia
}
console.log(removerPropriedade( produto, "nota"))
console.log(Object.is(removerPropriedade( produto, "nota"), produto))
